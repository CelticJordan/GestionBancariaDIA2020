...
namespace DIA_BANCO_V1
{
    ...
    static class Program
    {
        static void Main()
        {
            ...
            Prestamo p1 = new Prestamo( "12", "Consumo", "11111111111111111111", "22222222222222222222", 10800, 900, 12, DateTime.UtcNow);
            Prestamo p2 = new Prestamo( "13", "Consumo","22222222222222222222", "33333333333333333333", 10800, 90, 120, DateTime.UtcNow);
            Prestamo p3 = new Prestamo( "14", "Vivienda", "33333333333333333333", "11111111111111111111", 10500, 35, 30, DateTime.UtcNow);
