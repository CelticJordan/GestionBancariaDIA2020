    ...
    public class RegistroBanco
    {
        ...
        private XElement ToXmlCuenta(Cuenta cuenta)
        {
            ...
            toret.Add(
                ...
                {
                    clientesx.Add(new XAttribute(EtiquetaTitular, cl.Dni.ToString()));
                }
                toret.Add(clientesx);
        ...
        public List<Transferencia> CargarTransferenciasXml(String archivo)
        {
            ...
            if (documento.Root != null && documento.Root.Name == EtiquetaBancoClientes
            ) //en el caso de que encuentre un documento escrito
            {
