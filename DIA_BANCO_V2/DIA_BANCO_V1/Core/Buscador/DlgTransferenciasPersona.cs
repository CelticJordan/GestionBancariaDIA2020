...
namespace DIA_BANCO_V1
{
    ...
    using System;
    public class DlgTransferenciasPersona : Form
    {
        public DlgTransferenciasPersona(IEnumerable<Cliente> clients,IEnumerable<Cuenta> accounts,IEnumerable<Transferencia> trasnferences)
        {
        ...
        void Build()
        {
            ...
            {
                Size = new Size(420, 100), //Size(ancho, alto)
                Dock = DockStyle.Fill,
            ...
            this.Text = "Gestion de un banco - Buscar Transferencias por persona";
