...
namespace DIA_BANCO_V1
{
    ...
    public class DlgMovimientosPersona : Form
        {

        public DlgMovimientosPersona(IEnumerable<Cliente> clients,IEnumerable<Cuenta> accounts,IEnumerable<Transferencia> trasnferences,IEnumerable<Prestamo> loans)
        {
        ...
        void Build()
        {
            ...
            this.Text = "Gestion de un banco - Buscar movimientos por persona";
