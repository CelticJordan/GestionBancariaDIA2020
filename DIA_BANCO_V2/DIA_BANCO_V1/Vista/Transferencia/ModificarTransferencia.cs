namespace DIA_BANCO_V1
{
    ...
    public class ModificarTransferencia : WForms.Form
    {
        
        public ModificarTransferencia()
        {
            this.Build();
        }
        ...
        var pnlMain = new WForms.TableLayoutPanel
            ...
            //Boton modificar Transferencia
            this.BMoficarTransferencia = new WForms.Button {
                Dock = WForms.DockStyle.Top,
                Text = "Modificar Transferencia"
            };
            
            pnlMain.Controls.Add( BMoficarTransferencia);
        ...
        public WForms.Button BMoficarTransferencia { get; private set; }
